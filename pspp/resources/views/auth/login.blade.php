...
<div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-900 dark:border-gray-700">
    <form class="space-y-6"  method="POST" action="{{route('inicia-sesion')}}">
        @csrf
        <h5 class="text-xl text-gray-900 dark:text-white text-center font-semibold italic">Inicio de Sesión</h5>
        <div>
        ...
        <div class="flex items-start">
            ...
            <a href="/formulario-recuperar-contrasenia" class="ms-auto text-sm text-blue-700 hover:underline dark:text-blue-500">Recuperar contraseña</a>
        </div>
        ...
        <div class="flex items-center p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
            ...
            <div>
              <span class="font-medium">Error!</span>  {{ $errors->first('email') }}
            </div>
          </div>

     @endif
        <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
            ¿Sin cuenta? <a href="{{ route('register') }}" class="text-blue-700 hover:underline dark:text-blue-500">Crear Cuenta</a>
        </div>
    </form>
</div>
