...
<div>
    @if ($paginator->hasPages())
        <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between md:grid md:grid-cols-2 w-full gap-4">
                <div>
                ...
                <div>
                    <span class="relative z-0 inline-flex rtl:flex-row-reverse rounded-mdS shadow-sm">
                        <span>
                            {{-- Previous Page Link --}}
                            @if ($paginator->onFirstPage())
