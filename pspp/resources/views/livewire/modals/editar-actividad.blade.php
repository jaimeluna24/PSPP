                ...
                <form wire:submit.prevent="create()" enctype="multipart/form-data">
                    ...
                    <div class="grid gap-6 mb-3 md:grid-cols-2">
                        <div>
                            ...
                            <input type="text" id="first_name"  spellcheck="true" wire:model="areaActividad"
                        ...
                        <div>
                            ...
                            <input type="text" id="last_name"  spellcheck="true" wire:model="encargadoActividad"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required />
                                <p class="text-red-600 font-semibold italic">
                                    @error('encargadoActividad')
                                    {{ $message }}
                                    @enderror
                                </p>
                        </div>
                    ...
                    <div class="grid gap-6 mb-3 md:grid-cols-3">
                        <div>
                            ...
                            <input type="date" id="first_name" wire:model="fecha_inicioActividad"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                  />
                                 <p class="text-red-600 font-semibold italic">
                                    @error('fecha_inicioActividad')
                                    {{ $message }}
                                    @enderror
                                </p>
                        </div>
                    ...
                    <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                        <button type="submit" wire:click="editarActividad()"
