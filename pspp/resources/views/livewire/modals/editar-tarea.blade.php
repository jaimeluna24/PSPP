    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 space-y-4">
                <form wire:submit.prevent="editarTarea()" enctype="multipart/form-data">
                    <div class="mb-3">
                    ...
                    <div class="mt-3">
                        <div class="">
                            <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Resultados logrados</label>
                            <textarea wire:model="resultado" id="message" rows="2" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" ></textarea>
                        </div>
                            <p class="text-red-600 font-semibold italic">
                                @error('resultado')
                                {{ $message }}
                    ...
                    <div class="grid gap-6 mb-3 md:grid-cols-2 mt-3">
