<div>
    ...
    <div class="grid grid-cols-3 gap-5 pt-3">
        ...
        <div class="border-l pr-5 dark:border-gray-500  pl-5 border-r h-auto">
            ...
            <div>
                ...
                <div class="flex w-full justify-end mb-4 mt-4">
                    {{ $tareas->links() }}
                </div>
        ...
        <div>
            ...
            <div>
                <div class="dark:text-white ">
                    ...
                    <div class="dark:text-white ">
                        <p class="font-semibold ">Nombre:</p>
                        <p class="mb-3 text-gray-500 truncate dark:text-gray-400 text-sm">{{ $tareaSeleccionada->nombre }}</p>

                        <p class="font-semibold">Descripción:</p>
                        <p class="mb-3 text-gray-500 truncate dark:text-gray-400 text-sm">{{ $tareaSeleccionada->descripcion }}</p>

                        <p class="font-semibold">Resultado:</p>
                        @if (!empty($tareaSeleccionada->resultado))
                        <p class="mb-3 text-gray-500 truncate dark:text-gray-400 text-sm">{{ $tareaSeleccionada->resultado }}</p>
                        @else
                        <p class="mb-3 text-gray-500 truncate dark:text-gray-400 text-sm">Sin resultados</p>
                        @endif
                        <p class="font-semibold">Observación:</p>
                        <p class="mb-3 text-gray-500 truncate dark:text-gray-400 text-sm">{{ $tareaSeleccionada->observacion }}</p>

                        <p class="font-semibold ">Fecha de inicio:</p>
                        <p class="mb-3 text-gray-500 truncate dark:text-gray-400 text-sm">{{ $tareaSeleccionada->fecha_inicio }}</p>

                        <p class="font-semibold ">Fecha de finalización:</p>
                        @if (!empty($tareaSeleccionada->fecha_final))
                        <p class="mb-3 text-gray-500 truncate dark:text-gray-400 text-sm">{{ $tareaSeleccionada->fecha_final }}</p>
                        @else
                        <p class="mb-3 text-gray-500 truncate dark:text-gray-400 text-sm">En progreso</p>
                        @endif
    ...
    <div style="background-color: rgba(0,0,0,0.5)" id="popup-modal-actividad" tabindex="-1" class=" overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%)] max-h-full">
        @include('livewire.modals.eliminar-actividad')
    </div>
    @endif

   @if ($modalDeleteTarea)
   <div style="background-color: rgba(0,0,0,0.5)" id="popup-modal-tarea" tabindex="-1" class=" overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%)] max-h-full">
    @include('livewire.modals.eliminar-tarea')
   </div>
   @endif

    @if ($modalFinalizarActividad)
    <div style="background-color: rgba(0,0,0,0.5)" id="popup-modal-finalizar-actividad" tabindex="-1" class=" overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%)] max-h-full">
        @include('livewire.modals.finalizar-actividad')
    </div>
    @endif

    @if ($modalFinalizarTarea)
    <div style="background-color: rgba(0,0,0,0.5)" id="popup-modal-finalizar-tarea" tabindex="-1" class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%)] max-h-full">
    ...
    {{-- @endif --}}
     ...
     @endif
      ...
      <div style="background-color: rgba(0,0,0,0.5)" id="default-modal-evidencia-tarea-image" tabindex="-1" aria-hidden="true" class=" overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%)] max-h-full">
        @include('livewire.modals.evidencia-image-tarea')
      </div>
      @endif

     @if ($modalAgregarEvidenciaTarea)
     <div style="background-color: rgba(0,0,0,0.5)" id="default-modal-agregar-evidencia-tarea" tabindex="-1" aria-hidden="true" class=" overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%)] max-h-full">
