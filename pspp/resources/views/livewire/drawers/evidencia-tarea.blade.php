<h5 id="drawer-right-label" class="inline-flex items-center mb-4 text-base font-semibold text-gray-500 dark:text-gray-400"><svg class="w-4 h-4 me-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
   ...
   <p class="mb-6 text-sm text-gray-500 dark:text-gray-400">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-3">
        <div data-modal-target="default-modal-evidencia-tarea-image" data-modal-toggle="default-modal-evidencia-tarea-image">
   ...
   <div class="grid grid-cols-2 gap-4">
      <button data-drawer-hide="drawer-right-example" aria-controls="drawer-right-example" class="px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-200 rounded-lg focus:outline-none hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Cerrar</button>
      <button data-modal-target="default-modal-agregar-evidencia-tarea" data-modal-toggle="default-modal-agregar-evidencia-tarea"
